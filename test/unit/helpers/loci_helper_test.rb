...
class LociHelperTest < ActionView::TestCase
  def test_sense_select
    ...
    assert_equal([["Test dictionary: literal, -alis (adj.)", [["First sense", 1], ["Second sense", 2], ["(new sense under this subentry...)", "new-1"]]]], sense_select(probandum), 
  ...
  test "sense select handles null dictionary" do
    ...
    assert_equal [["(No dictionary): ----- (none)", [["A series of dashes.", 10], ["(new sense under this subentry...)", "new-10"]]]], sense_select(probandum)
  end
end